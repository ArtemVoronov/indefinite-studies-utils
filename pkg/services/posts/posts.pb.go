...
type GetPostsReply struct {
	...
	Users []*GetPostReply `protobuf:"bytes,1,rep,name=users,proto3" json:"users,omitempty"`
}
...
func (x *GetPostsReply) GetUsers() []*GetPostReply {
	if x != nil {
		return x.Users
	}
	return nil
...
type GetCommentsReply struct {
	...
	Users []*GetCommentReply `protobuf:"bytes,1,rep,name=users,proto3" json:"users,omitempty"`
}
...
func (x *GetCommentsReply) GetUsers() []*GetCommentReply {
	if x != nil {
		return x.Users
	}
	return nil
...
var file_pkg_services_posts_posts_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x23,
	...
	0x28, 0x05, 0x42, 0x02, 0x10, 0x01, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0x40, 0x0a, 0x10, 0x47,
	...
	0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x32, 0x9b, 0x03,
...
var file_pkg_services_posts_posts_proto_depIdxs = []int32{
	...
	1,  // 2: posts.GetPostsReply.users:type_name -> posts.GetPostReply
	...
	5,  // 5: posts.GetCommentsReply.users:type_name -> posts.GetCommentReply
